	...
	return (
		<>
          ...
          Personal details and application.
						...
						{detail.status ? (
							<span className="bg-emerald-50 px-2 rounded-full h-fit items-center font-medium text-emerald-700 text-xs">
								Active
							</span>
						) : (
							<span className="bg-rose-50 px-2 rounded-full h-fit items-center font-medium text-rose-700 text-xs">
								Not active
							</span>
						)}
					</div>
					<button
						...
						type="button"
						className="order-0 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:order-1 sm:ml-3"
					>
						Approve
					</button>
				</div>
