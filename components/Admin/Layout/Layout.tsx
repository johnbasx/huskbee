...
const teams = [
  { name: "Fundraiser List", href: "#", bgColorClass: "bg-indigo-500" },
    ...
    <div className="min-h-full bg-white">
      ...
      <div className="lg:pl-64 flex flex-col">
        ...
        <main className="flex-1">
          {/* Page title & actions */}
          <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 shadow-lg">
