...
const ScrollCards = () => {
  ...
  return (
    <div className="">
      ...
      >
        <Card
          imageSrc="https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8ZXZlbnR8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60"
          title="Hybrid Nation"
          date="24 Nov, 2022"
          about="Coming to rock your town, here comes the Hybrid Nation. Event organized by NOS Groups."
          link="#!"
          pill="Hot"
