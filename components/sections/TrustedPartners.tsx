  ...
  return (
    <div className="py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="text-left text-3xl font-bold leading-8 text-gray-900">
          Our trusted NGOs & <span className='font-serif italic text-blue-600'>Organizing partners</span>
        </h2>
