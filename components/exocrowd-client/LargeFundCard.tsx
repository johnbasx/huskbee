...
const LargeFundCard = () => {
  return (
    <a
      href='#!'
      className='relative mr-3 block w-[17rem] overflow-hidden rounded-3xl border border-neutral-200 bg-white p-4 sm:p-4 md:w-[20rem] lg:p-4'
    >
      ...
      />
      <span className='absolute inset-x-0 bottom-0 h-2 bg-black' />
      ...
      <div className='mt-2 sm:flex sm:justify-between sm:gap-4'>
        <div>
          ...
          <p className='mt-1 line-clamp-1 text-xs font-medium text-neutral-600'>
      ...
      {/* <dl className="mt-4 flex gap-4 sm:gap-6">
                <div className="flex flex-col-reverse">
                    <dt className="text-sm font-medium text-neutral-600">3 hours ago</dt>
                    <dd className="text-xs text-neutral-500">Last donation</dd>
                </div>

                <div className="flex flex-col-reverse">
                    <dt className="text-sm font-medium text-neutral-600">26 Days</dt>
                    <dd className="text-xs text-neutral-500">Days left</dd>
                </div>
            </dl> */}
      <div className='mt-4'>
        <span className='text-xs text-neutral-500'>Latest activities</span>
        <div className='flex flex-row-reverse justify-end px-3'>
          <div className='relative m-1 ml-0 mr-1 flex h-10 w-auto items-center justify-center rounded-full text-[0.6rem] text-neutral-500 md:text-xs'>
            +5100 others
          </div>
