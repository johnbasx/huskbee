...
const FundCard = ({
  ...
  return (
    <Link
      href='#!'
      className='md:[20rem] relative mr-3 block w-[17rem] overflow-hidden rounded-3xl border border-neutral-200 bg-white p-4'
    >
      <Image
        alt='Home'
        height={500}
      ...
      <div className='mt-2 sm:flex sm:justify-between sm:gap-4'>
        <h3 className='line-clamp-2 text-lg font-bold text-neutral-950 sm:text-xl'>
