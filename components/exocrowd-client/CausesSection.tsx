...
const CausesSection = () => {
  return (
    <section>
      <div className='sm:py-18 mx-auto max-w-screen-2xl px-4 py-14 sm:px-6 lg:px-8 lg:py-40'>
          ...
          <div className='grid grid-cols-2 gap-4 md:grid-cols-3'>
            {causesData.map((item, index) => (
              ...
              >
                ...
                <div className='relative h-full bg-gradient-to-t from-black/90 to-neutral-900/25 text-white'>
                  <div className='p-4'>
                    <item.Icon className='h-6 w-6' />

                    <h3 className='mt-6 text-lg font-bold text-white sm:mt-8 lg:mt-10'>
                      {item.title}
                    </h3>
