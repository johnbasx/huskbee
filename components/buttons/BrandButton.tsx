...
export const InterestedButton = () => (
  <button className="flex justify-center text-center text-lg bg-purple-600/20 hover:bg-purple-700/20 w-auto transition duration-200 border-purple-500/20 border rounded-lg p-2 font-bold text-a">
