			...
			<div className="col-span-6 sm:col-span-4 max-w-3xl flex items-center justify-between">
				<div className="-mt-px w-0 flex-1 flex">
					<button
						...
						onClick={() => PrevHandler()}
						className={
							"border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium text-gray-800 hover:text-black cursor-pointer disabled:text-gray-500 disabled:cursor-not-allowed"
						}
					>
						<TbArrowLeft
				...
				<div className="flex items-center gap-x-2 float-right">
					...
					<div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-400 border-transparent border-b-gray-300 bg-transparentfocus:border-transparent focus:border-b-gray-300 focus:ring-0 sm:max-w-md px-2 ">
						<input
							...
							className="w-28 sm:w-24 block flex-1 border-0 bg-transparent py-1.5 pl-1 text-black placeholder:text-gray-600 focus:ring-0 sm:text-sm sm:leading-6 placeholder:text-xs"
