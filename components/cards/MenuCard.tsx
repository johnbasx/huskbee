...
const MenuCard = () => {
	const MenuCardWrapper = ({ icon: Icon }: { icon: IconType }) => (
		<button
			type="button"
			className="p-3 bg-zinc-800/50 border border-zinc-500/10 rounded-2xl flex justify-center items-center duration-300 cursor-pointer hover:bg-zinc-700/50 "
		>
	...
	return (
		<div className="relative w-full px-3">
			...
			<div className="relative">
				<div className="absolute inset-0 bg-colofulLogo h-screen blur-3xl pointer-events-none opacity-50" />
			</div>
		</div>
	);
};
