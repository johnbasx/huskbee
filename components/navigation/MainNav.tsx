...
const MainNav = () => {
  ...
  return (
    <>
      <div className='supports-backdrop-blur:bg-white/60 sticky top-0 z-40 w-full flex-none bg-black/10 backdrop-blur transition-colors duration-500 dark:border-neutral-50/[0.06] dark:bg-black/10 lg:z-50 lg:border-b lg:border-neutral-900/10'>
        <div className='max-w-14xl mx-auto'>
          <div className='mx-4 flex border-b border-neutral-900/10 py-4 dark:border-neutral-300/10 lg:mx-0 lg:border-0 lg:px-8'>
            <a href='#!' className='relative flex items-center justify-center'>
              ...
              <h1 className='h-10 w-auto text-center text-3xl font-extrabold'>
                Exocrowd
              </h1>
            </a>

            <a
              className='ml-3 hidden items-center rounded-full bg-purple-400/10 px-3 py-1 text-xs font-medium leading-5 text-purple-600 hover:bg-purple-400/20 dark:text-purple-400 xl:flex'
              href='#!'
            >
            ...
            <div className='relative ml-auto hidden items-center lg:flex'>
              <nav className='text-sm font-semibold leading-6 text-neutral-700 dark:text-neutral-100'>
              ...
              <div className='ml-6 flex items-center border-l border-neutral-200 pl-6 dark:border-neutral-800'>
                ...
                >
                  <span className='dark:hidden'>
                    <svg
                      ...
                      className='h-6 w-6'
                    >
                      <title>Listbox button SVG</title>
                      <path
                ...
                >
                  <span className='sr-only'>Exocrowd on Github</span>
                  <svg
                    viewBox='0 0 16 16'
                    className='h-5 w-5'
                    fill='currentColor'
                    aria-hidden='true'
                  >
                    <title>Exocrowd github button SVG</title>
            ...
            <div className='-my-1 ml-2 lg:hidden'>
              <button
                type='button'
                className='flex h-8 w-8 items-center justify-center text-neutral-100 hover:text-neutral-300'
                onClick={() => setMoreIsOpen(true)}
              >
                <span className='sr-only'>Navigation</span>
                <svg width='24' height='24' fill='none' aria-hidden='true'>
                  <title>Navigation SVG</title>
        ...
        <div className='flex items-center border-b border-neutral-900/10 p-4 dark:border-neutral-50/[0.06] lg:hidden'>
          <button
            type='button'
          ...
          <ol className='ml-4 flex min-w-0 whitespace-nowrap text-sm leading-6'>
            <li className='truncate font-semibold text-neutral-900 dark:text-neutral-200'>
              Resources
            </li>
          </ol>
        </div>
