  ...
  return (
    <>
      <button
        ...
        type='button'
        className='group -ml-1 flex items-center rounded-md bg-transparent p-1 focus:outline-none '
      >
        <span className='flex h-8 w-8 items-center justify-center rounded-full border-2 border-dashed border-neutral-300 text-neutral-400'>
              ...
              >
                <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-neutral-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg'>
                  <div className='bg-neutral-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4 '>
                    <div className='h-auto w-full max-w-md px-2 py-4 sm:px-0'>
                      <Tab.Group>
