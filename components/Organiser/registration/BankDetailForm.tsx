      ...
      >
          ...
          <div className="flex h-6 items-center">
            <Switch
              ...
              className={classNames(
                agreed ? "bg-indigo-600" : "bg-neutral-200",
                "flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-neutral-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              )}
            >
        ...
        <div className='mt-10 flex justify-between space-x-4'>
          <button
            ...
            className='block w-full cursor-pointer rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
          >
            Prev
          </button>
          <button
