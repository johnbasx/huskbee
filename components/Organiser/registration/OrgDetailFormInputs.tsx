		...
		<div>
			...
			<div className="mt-2.5">
				<input
					...
					className={clsx(
						"block w-full rounded-md border-0 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 mb-1",
						errors.username
							? "focus:ring-red-500 text-red-600"
							: "text-gray-900 focus:ring-indigo-600",
					)}
				/>
