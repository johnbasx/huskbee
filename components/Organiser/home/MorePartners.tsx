	...
	return (
		<div className=" w-full bg-transparent shadow-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5">
			...
			<div className="flex ">
				<button
					type="button"
					className="w-full border border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-indigo-300 hover:text-indigo-400"
				>
					Detail
				</button>
			</div>
