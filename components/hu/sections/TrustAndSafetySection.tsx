  ...
  return (
    <section className="bg-blue-700 flex justify-center items-center min-h-[70vh] py-28 px-6">
      <motion.div className="mx-auto text-white max-w-screen-2xl flex flex-col gap-10">
        ...
        <div>
          <button className="bg-transparent font-semibold text-sm text-slate-950 hover:bg-blue-50 duration-200 rounded-full py-2 hover:px-4 flex items-center justify-start gap-2">
