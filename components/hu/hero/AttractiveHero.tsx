...
const AttractiveHero = () => {
  return (
    ...
    <section className="py-8 md:py-20 relative bg-transparent bg-heroImage bg-center bg-no-repeat bg-cover">
      <div className="bg-gradient-to-b isolate from-black/80 to-slate-950 via-black/30 absolute inset-0"></div>
      <div className="mx-auto relative max-w-screen-2xl px-4 py-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="bg-white shadow-xl shadow-black/5 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 lg:px-8 lg:py-12">
            <div className="mx-auto max-w-xl">
              ...
              />
              <div className="flex mt-8 md:mt-20 mb-6 flex-wrap gap-1 md:gap-2">
              ...
              <div className="mt-6 md:mt-12 flex flex-wrap items-center gap-2">
                <Link
                  href="#!"
                  className="inline-flex items-center gap-2 rounded-full px-6 py-3 bg-slate-950 text-white font-semibold text-lg transition hover:bg-slate-800"
                >
                  Start helping now
