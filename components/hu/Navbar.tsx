    ...
    <nav className="bg-white isolate border-b border-slate-200 sticky top-0 z-40">
      ...
      <div className="px-4 lg:px-6 py-3 lg:py-5">
        <div className="flex items-center justify-between mx-auto max-w-screen-2xl lg:px-6">
          ...
          <div className="flex justify-end gap-x-1 items-center lg:hidden">
            {/* <Link
              href='#!'
              className='px-3.5 inline-flex items-center gap-1 py-3 text-sm font-semibold text-white duration-150 rounded-full bg-slate-950 hover:bg-slate-800'
            >
              Help Manipur
          ...
          <div className="hidden gap-4 lg:flex lg:flex-1 lg:justify-end">
            <button className="px-4 py-2 text-sm font-semibold text-white duration-150 rounded-full bg-slate-950 hover:bg-slate-800">
              Start a fundraiser
            </button>
            <Link
              href="#!"
      ...
      <Transition appear as={Fragment} show={mobileMenuOpen}>
        <Dialog as="div" onClose={setMobileMenuOpen}>
          ...
          >
            <Dialog.Panel
              className="fixed inset-0 z-50 px-4 py-5 overflow-y-auto bg-slate-950 lg:hidden"
