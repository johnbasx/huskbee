...
export default function Document() {
  return (
    <Html lang='en' className='bg-neutral-50 font-sans antialiased'>
      <Head>
      ...
      {/* <body className="bg-gradient-to-b from-black via-neutral-900 to-black text-neutral-100 antialiased"> */}
      <body>
        <Main />
        <NextScript />
