...
import { sanitizedData } from '@utils/lib';
import ChartAnalyticsOrganiserDonations from '@components/organiser/fundraiser-detail/ChartAnalyticsOrganiserDonations';
...
const FunraiserDetail = ({
  ...
  return (
    <Layout pageTitle='Fundraiser detail'>
      <Toaster />
      <div className='mx-auto max-w-3xl  space-y-12 pb-20 sm:px-6 lg:max-w-7xl'>
        <main className=''>
            ...
            >
              <dl className='grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2'>
                ...
                <div className='sm:col-span-2'>
                  ...
                  <dd
                    className='mt-1 text-sm capitalize text-neutral-900'
                    dangerouslySetInnerHTML={sanitizedData(detail.description)}
                  />
                </div>
              </dl>
            </DetailWrapper>
        ...
        <ChartAnalyticsOrganiserDonations
          graphData={fund_donations_graph_data}
        />
