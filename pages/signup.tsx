...
import GetPhoneNumberModal from '@components/GoogleSignUp/GetPhoneNumberModal';
...
const SignUpPage = () => {
  ...
  const onSubmit: SubmitHandler<FormData> = async data => {
    ...
    const status = ComparePassword(data.password, data.confirm_password)
    if (status === true) {
      ...
      try {
        ...
        const response = await axios.post(USER_BASE_URL + 'huskbee-user-signup', newdata);
        toast.success('Signup successful');
  ...
  return (
    <>
      <GetPhoneNumberModal open={open} setOpen={setOpen} googleToken={googleToken} />
      <Toaster />
          ...
          <main className='relative flex items-center justify-center bg-white px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6'>
            ...
            <div className='max-w-xl lg:max-w-3xl'>
              ...
              <p className='mt-4 leading-relaxed text-neutral-500'>
                ...
                and the ones you are raising funds yy
              </p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className='mt-8 grid grid-cols-6 gap-6'>
                ...
                <div className='col-span-6 sm:flex sm:items-center sm:gap-4'>
                  <button type='submit' className='inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-blue-700 hover:text-blue-50 focus:outline-none focus:ring active:text-blue-50'>
                    Create account
                  </button>
